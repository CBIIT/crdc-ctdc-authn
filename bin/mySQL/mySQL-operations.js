...
// async function clearEventsAfterTimestamp(timestamp) {
//     let currentConnection = null;
//     try {
//     const currentConnection = await new Promise((resolve, reject) => {
//         connection.getConnection((err, connection) => {
...
//     if (sessionID !== null) {
//         const rows = await new Promise((resolve, reject) => {
//             currentConnection.query("DELETE FROM ctdc.eventTable WHERE timestamp > '" + timestamp + "';", (err, rows) => {
//                 if (err) reject(err);
//                 else resolve(rows);
//             });
//         });
...
// async function getEventsAfterTimestamp(timestamp,eventType) {
//     let currentConnection = null;
//     try {
//     const currentConnection = await new Promise((resolve, reject) => {
//         connection.getConnection((err, connection) => {
...
//     if (sessionID !== null) {
//         const rows = await new Promise((resolve, reject) => {
//             currentConnection.query("SELECT * FROM ctdc.eventTable WHERE timestamp > '" + timestamp + "';", (err, rows) => {
//                 if (err) reject(err);
//                 else resolve(rows);
//             });
//         });
